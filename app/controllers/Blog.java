...
/**
 * Class to facilitate displaying list of posts, creation of a new post and the
 * deletion of a specified post
 * 
...
public class Blog extends Controller {
	...
	/**
	 * Finds and displays a comment associated with a specified post Renders
	 * user and posts to the index page
	 */
